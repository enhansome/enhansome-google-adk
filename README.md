...
* [google/adk-python](https://github.com/google/adk-python) ⭐ 21,096 | 🐛 566 | 🌐 Python | 📅 2026-08-13 - The official Python implementation of Google's Agent Development Kit
* [google/adk-samples](https://github.com/google/adk-samples) ⭐ 10,155 | 🐛 75 | 🌐 Python | 📅 2026-08-13 - Official sample agents built with Google's ADK
* [google/adk-docs](https://github.com/google/adk-docs) ⭐ 1,468 | 🐛 214 | 🌐 Shell | 📅 2026-08-13 - Official documentation for the Google Agent Development Kit
...
* [kweinmeister/agentic-trading](https://github.com/kweinmeister/agentic-trading) ⭐ 251 | 🐛 6 | 🌐 Python | 📅 2026-07-27 - Sample application demonstrating Google ADK and A2A interoperability for trading
...
* [abhishekkumar35/google-adk-nocode](https://github.com/abhishekkumar35/google-adk-nocode) ⭐ 24 | 🐛 2 | 🌐 Python | 📅 2025-04-10 - Visual, no-code interface for creating AI agents with Google ADK (supports cloud and local Ollama models)

### Templates & Starters

* [GoogleCloudPlatform/agent-starter-pack](https://github.com/GoogleCloudPlatform/agent-starter-pack) ⭐ 6,534 | 🐛 49 | 🌐 Python | 📅 2026-07-21 - A collection of production-ready Generative AI Agent templates built for Google Cloud. It accelerates development by providing a holistic, production-ready solution. Includes samples with Google's ADK.
...
* [kkdai/linebot-adk](https://github.com/kkdai/linebot-adk) ⭐ 33 | 🐛 0 | 🌐 Python | 📅 2026-03-26 - LINE Bot template that works with Google's ADK
...
* [AashiDutt/Google-Agent-Development-Kit-Demo](https://github.com/AashiDutt/Google-Agent-Development-Kit-Demo) ⭐ 65 | 🐛 3 | 🌐 Python | 📅 2025-05-25 - ADK-powered travel planner
* [heurist-network/dev-examples/python/adk-google-sheet-mcp-project](https://github.com/heurist-network/dev-examples/tree/main/python/adk-google-sheet-mcp-project) ⭐ 43 | 🐛 2 | 🌐 Python | 📅 2025-09-05 - Crypto data pipeline using Google ADK that integrates with MCP servers to fetch real-time data and automatically save it to Google Sheets
...
* [IhateCreatingUserNames2/Cognisphere](https://github.com/IhateCreatingUserNames2/Cognisphere) ⭐ 17 | 🐛 1 | 🌐 Python | 📅 2025-06-06 - Cognisphere ADK, an AI agent development framework built on Google's ADK
...
* [trung-tlt/weather-agent-ai](https://github.com/trung-tlt/weather-agent-ai) ⭐ 1 | 🐛 0 | 🌐 Python | 📅 2025-04-18 - Weather information agent using Google ADK with OpenAI and Anthropic model integration via LiteLLM
* [VeereshGowda/google-adk-multiagent](https://github.com/VeereshGowda/google-adk-multiagent) ⭐ 0 | 🐛 0 | 🌐 Python | 📅 2025-04-15 - Multi-agent system using Azure OpenAI models with Google's ADK
...
* [GitHub Discussions – google/adk-python](https://github.com/google/adk-python/discussions) ⭐ 21,096 | 🐛 566 | 🌐 Python | 📅 2026-08-13 - Official discussion board for feature requests and troubleshooting
...
* [Awesome AI Agents](https://github.com/e2b-dev/awesome-ai-agents) ⭐ 29,402 | 🐛 924 | 📅 2026-07-09 - A curated list of awesome AI agents and related resources
* [Awesome LLM](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,258 | 🐛 439 | 📅 2025-07-31 - A curated list of Large Language Models

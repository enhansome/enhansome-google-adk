...
* [google/adk-python](https://github.com/google/adk-python) ⭐ 21,524 | 🐛 503 | 🌐 Python | 📅 2026-09-13 - The official Python implementation of Google's Agent Development Kit
* [google/adk-samples](https://github.com/google/adk-samples) ⭐ 10,310 | 🐛 79 | 🌐 Python | 📅 2026-09-12 - Official sample agents built with Google's ADK
...
* [GoogleCloudPlatform/agent-starter-pack](https://github.com/GoogleCloudPlatform/agent-starter-pack) ⭐ 6,556 | 🐛 50 | 🌐 Python | 📅 2026-07-21 - A collection of production-ready Generative AI Agent templates built for Google Cloud. It accelerates development by providing a holistic, production-ready solution. Includes samples with Google's ADK.
...
* [GitHub Discussions – google/adk-python](https://github.com/google/adk-python/discussions) ⭐ 21,524 | 🐛 503 | 🌐 Python | 📅 2026-09-13 - Official discussion board for feature requests and troubleshooting
...
* [Awesome AI Agents](https://github.com/e2b-dev/awesome-ai-agents) ⭐ 29,987 | 🐛 1,029 | 📅 2026-08-21 - A curated list of awesome AI agents and related resources
* [Awesome LLM](https://github.com/Hannibal046/Awesome-LLM) ⭐ 27,366 | 🐛 456 | 📅 2025-07-31 - A curated list of Large Language Models
